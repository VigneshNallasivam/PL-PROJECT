 ...
 <div
      ...
      >
        <div>
          ...
          Provider Name :  ${providerName}
           ...
           <p style="font-size: 15px">
          Intelizign <span style="color: blueviolet;">P&L-Project</span> is going to be Completed within 2 Days
          </p>
          <p
            style="
              font-size: 13px;
    ...
    <div style="display: flex; flex-direction: row; justify-content: center; padding-left: 40%;">
      <div>
        ...
        <p style="font-size: 10px;">© 2023 <a href="https://iconnect.intelizign.com/#/" id="about">Intelizign PL</a></p>
